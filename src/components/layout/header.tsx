...
export function Header({ userEmail, onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-[var(--brand-navy)]/[0.05] bg-white/92 backdrop-blur-xl">
      <div className="mx-auto flex h-[68px] w-full max-w-[1400px] items-center gap-4 px-4 sm:px-6 md:px-8 lg:px-10">
        <div className="flex min-w-0 flex-1 items-center gap-3 md:gap-4">
          ...
          <div className="hidden min-w-0 md:block">
            <p className="font-display text-[1.4rem] font-semibold leading-none tracking-tight text-[var(--brand-navy)]">
              TR Control
              <span className="ml-1.5 font-sans text-[0.92rem] font-bold tracking-[0.06em] text-[var(--brand-coral)]">
                ERP
              </span>
            </p>
          ...
          <div className="hidden h-8 w-px bg-[var(--brand-navy)]/8 lg:block" />

          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="h-10 max-w-[200px] gap-2 rounded-full px-2.5 hover:bg-[var(--brand-navy)]/[0.04] sm:max-w-[260px]"
              >
                ...
                <span className="truncate text-sm font-semibold text-[var(--brand-navy)]">
        ...
        <div className="hidden items-center gap-2 rounded-full bg-[var(--brand-navy)]/[0.03] px-3.5 py-2 text-sm text-muted-foreground xl:flex">
          <CalendarDays
        ...
        <div className="flex shrink-0 items-center gap-2.5 md:gap-3">
          <div className="hidden items-center gap-2.5 sm:flex">
            <Avatar className="h-9 w-9 ring-2 ring-[var(--brand-coral)]/20">
          ...
          <Button
            ...
            className="h-9 gap-2 rounded-full border-[var(--brand-gold)]/50 px-3.5 text-[var(--brand-navy)] transition-all hover:border-[var(--brand-gold)] hover:bg-[var(--brand-gold)]/10"
          >
            <LogOut
