-- TR Control ERP — Dashboard Executivo
-- Migration: 017_executive_dashboard
-- Idempotente. Sem tabelas novas: agrega via RPC SECURITY DEFINER
-- reutilizando cash_flow_entries + helpers do módulo 016.
...
COMMENT ON FUNCTION public.get_executive_dashboard(UUID, DATE, DATE) IS
  'Dashboard Executivo: KPIs, séries, listas e alertas da empresa ativa.';
